 ...
 */
 //定义一个类，属性1：存放MatrixEntry的dataset，属性2,3：行数，列数
 //matrixEntry实际上就是矩阵中的一个元素（1，行数2.列数3.元素值）
 //RowMatrix由vector组成，coordinatedMatrix由matrixEntry组成
 //IndexRowMatrix实际上就是每一行是index加上vector
